...
# against (ort 2.0.0-rc.10 <-> onnxruntime 1.22.x), so `dnf install linhello`
# resolves a working runtime natively.
#
...
against so face authentication works out of the box.
